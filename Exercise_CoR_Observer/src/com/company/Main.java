...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        fileLogger.log(fileLogger.getNotification(request1));
        ...
        fileLogger.log(fileLogger.getNotification(request2));
        /**
         * Expected output :
        ...
        fileLogger.log(fileLogger.getNotification(request3));
        ...
        fileLogger.log(fileLogger.getNotification(request4));
